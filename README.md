...
> to open Find & Replace across all files. Search for `Test React App` and replace it with your brand name everywhere at once.
...
|----------------|-------------|------------------------------|
| Company name (`Test React App`) | All `.html` files | Use Find & Replace to update it everywhere |
